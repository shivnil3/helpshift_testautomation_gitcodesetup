...
/** This class is a modified version of the HTMLLayout and overrides most of its methods. 
 * @author nil
 *
 */
public class CustomizedHTMLLayout extends HTMLLayout {
	  ...
	  */
	  ...
	  String format(LoggingEvent event) {
	    ...
	    String escapedThread="nilesh thread";
	    ...
	    if(locationInfo) {
	     ...
	     // sbuf.append(Transform.escapeTags(locInfo.getFileName()));
	      sbuf.append(Globals.getCurrentClassName());
	      /*sbuf.append(':');
	  ...
	  */
	  ...
	  String getHeader() {
	    ...
	    sbuf.append("<th>TestCase</th>" + Layout.LINE_SEP);
	    sbuf.append("<th>Level</th>" + Layout.LINE_SEP);
	    sbuf.append("<th>Mesage</th>" + Layout.LINE_SEP);
	    if(locationInfo) {
